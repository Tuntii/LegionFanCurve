...
internal static class GamezoneWmi
{
    ...
    public static void SetPerformanceMode()
    {
        ...
        foreach (ManagementObject o in searcher.Get())
        {
            ...
            // Ensure forced full-blast cooling is OFF so our EC curve can work
            try
            {
    ...
    /// <summary>
    /// Gamezone WMI temps are often stuck at 0 on 15ARH05H BIOS; still try as fallback.
    /// </summary>
    ...
    /// <summary>ACPI thermal zones (often package/zone, not always accurate package die).</summary>
